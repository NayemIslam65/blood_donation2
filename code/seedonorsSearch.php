<?php 
    ...
    if (isset($_POST['submit-search'])){
        ...
        $search = mysqli_real_escape_string($conn, $_POST['bloodgroup']);
        $select_sql="SELECT * FROM donor WHERE blood_group LIKE '%$search%'";
        $select_query=$conn->query($select_sql);

    } elseif (isset($_POST['submit-location'])){

        $search_location = mysqli_real_escape_string($conn, $_POST['location']);
        $select_sql="SELECT * FROM donor WHERE address LIKE '%$search_location%'";
        $select_query=$conn->query($select_sql);
              ...
              <div class="col-md-12 col-lg-12">      
                 ...
                 <div class="row" style="margin: 40px 0px;">
                    ...
                    <div class="card">
                     ...
                     <span style="color:white;"><?php echo $data['blood_group']; ?></span><span class="card_img"> <img src="images/card_logo1.png" class="img-fluid" alt="card_logo"> </span>
  </div>
                    <img class="card-img-top" src="images/person.jpg">
                    <div class="card-block">
                    
                        <h4 class="card-title2 text-center mt-3 custom_last" style="color: #8B0D32 !important;"><?php echo $data['full_name']; ?></h4>
